This building block demonstrates the functionality of a HID-emulation dongle (mouse, keyboard and joystick) of [AsTeRICS] (https://github.com/asterics/AsTeRICS).
